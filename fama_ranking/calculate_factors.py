...
def calculate_rolling_factors(report_df):
    """
    Beräknar rullande faktorer för finansiella rapportdata.
    
    Parametrar:
    report_df (DataFrame): DataFrame innehållande finansiella rapportdata.
    
    Returnerar:
    DataFrame: DataFrame med rullande summor för intäkter, bruttoresultat, rörelseresultat och vinst per aktie.
    """
    ...
    print("Rullande faktorer beräknade.")
    return report_df

def calculate_factors(price_df, report_df):
    """
    Beräknar olika finansiella faktorer baserat på pris- och rapportdata.
    
    Parametrar:
    price_df (DataFrame): DataFrame innehållande prisdata.
    report_df (DataFrame): DataFrame innehållande finansiella rapportdata.
    
    Returnerar:
    DataFrame: DataFrame med beräknade finansiella faktorer.
    """
